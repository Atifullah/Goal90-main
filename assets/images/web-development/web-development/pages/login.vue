      ...
      <div class="main-content">
        <div class="auth">
          <a-row class="login-details">
            <a-col :lg="{span:22,offset:1}" :xl="{span:18,offset:3}">
              <a-row class="parent">
                <a-col :lg="12" class="login-left py-5">
                    ...
                    <a-col :lg="24">
                      ...
                      <a-tabs default-active-key="1" v-model="tab" @change="signModel.username = ''">
                        <a-tab-pane key="1">
                          <span slot="tab">
                            <img
                              :src="tab == '1' ? '/images/email-icon-active.svg' : '/images/email-icon.svg'"
                              class="mr-1" />
                            {{ $t('last.la9') }}
                            <p v-show="tab == '1'" class="bottom-line"></p>
                          </span>
                          <a-form-model ref="authForm" :model="signModel" :rules="setValidation.rules"
                            :hide-required-mark="true" label-align="left">
                            <a-row>
                              <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                <a-form-model-item has-feedback :label="$t('person.pd14')" prop="username" :colon="false"
                                  :wrapper-col="{
                                    xl: 24,
                                    lg: 24,
                                    md: 24,
                              ...
                              <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                <a-form-model-item :label="$t('person.psd')" prop="password" has-feedback :colon="false"
                                  :wrapper-col="{
                                    xl: 24,
                                    lg: 24,
                                    md: 24,
                                  ...
                                  <a-input-password v-model="signModel.password" prop="password"
                            ...
                            <a-row>
                              <a-col :lg="24" align="end">
                                <nuxt-link to="reset-password" href="#" class="forgot-pass fw-5">{{ $t('last.la10')
                                }}</nuxt-link></a-col>
                            </a-row>
                            <a-row>
                        ...
                        <a-tab-pane key="2" class="phone-no-tab">
                          <span slot="tab">
                            <img
                              :src="tab == '2' ? '/images/phone-icon-active.svg' : '/images/phone-icon.svg'"
                              class="mr-1" />
                            {{ $t('last.la12') }}
                          ...
                          <a-form-model ref="authForm" :model="signModel" :rules="setValidation.rules"
                            ...
                            <a-row>
                              <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                <a-form-model-item has-feedback :label="$t('labels.lbl9')" prop="phone" :colon="false"
                                  :wrapper-col="{
                                    xl: 24,
                                    lg: 24,
                                    md: 24,
                  ...
                  <a-row class="right-box">
                    <a-col :lg="24" align="end">
                          ...
                          <div class="div_content_sanning_login">
                            <div id="qrCode" class="">
                              ...
                              <p v-if="!qr_success"
                                ...
                                {{ $t('login.click') }} [<img src="../static/images/Iconly-Broken-Scan.png"
                      ...
                      <p class="pt-5" style="font-size:15px; font-weight:500; text-align:center; margin:60px 0px;">
                        {{ $t('login.scanCode') }}
                        <span style="color:#FFA500">{{ $t('login.Bitnasdaq') }} <br /> {{ $t('login.mobileApp') }}</span>
                        {{ $t('login.instantly') }}
                      </p>
                    </a-col>
                  </a-row>
