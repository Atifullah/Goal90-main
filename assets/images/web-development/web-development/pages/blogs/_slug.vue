...
export default {
  ...
  async asyncData({ params, store, app }) {
    ...
    const subItemTitle = params.slug
     await store.dispatch('article/fetchChannelInfo', { channelID: blogChannelId, subTitle: subItemTitle });  // Replace with your API call
  ...
  methods: {
    ...
    async fetchData() {
      ...
      await this.fetchChannelInfo({ channelID: blogChannelId, subTitle: subItemTitle })
    }
  },
