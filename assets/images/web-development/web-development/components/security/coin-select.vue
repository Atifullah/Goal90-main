...
<script>
  export default {
    ...
    methods: {
      getCion(){
        var currencyinfos=this.$store.state.currencyinfos;
        this.getCurrencyList=currencyinfos;
        this.stockpile =currencyinfos; 
      },
  ...
  .baseselect {
    ...
    .searchBox {
      .ipt_hover {
        ...
        background: url('./../../static/images/an_select_down.png') no-repeat 97% center;
      }
      .ipt_hover.cl_333 {
        color: #333;
      }
      ...
      .hovers {
        border: 1px solid #8583ac;
        background: url('./../../static/images/an_select_up.png') no-repeat 97% center;
      }
    }
    .skill {
      position: absolute;
