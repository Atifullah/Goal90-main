<template>
    <div class="language">
        <a-modal id="language" v-model="isLanguage" width="800px" :footer="false" :title="false"
            @cancel="handleLanguageModal">
            ...
            <div class="scroll_div">
                <a-row :gutter="16" class="px-4 mx-2 mb-4">
                    ...
                    <a-col :lg="12">
                        <a-input ref="userNameInput" :placeholder="$t('placeholders.plh5')">
                            <span slot="prefix">
                ...
                <a-row :gutter="16" class="pt-4 mt-3 px-4 mx-2">
                    <a-col v-for="(     list, key     ) in      langList     " :key="key" :lg="6"
