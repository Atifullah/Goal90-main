    ...
    <div class="">
        <div id="header">
            <a-row :gutter="16" class="m-0 p-0 header-row">
                <a-col :xs="14" :sm="14" :md="14" :lg="4" :xl="3" :xxl="2" class="pr-0">
                    <span class="header-logo">
                        <nuxt-link to="/">
                            <img src="/images/logo.svg" height="26" />
                        </nuxt-link>
                    </span>
                    <a-popover :title="false" trigger="hover" overlay-class-name="menu-popover promotion-popover"
                        ...
                        <div class="logo1-icon-img" @mouseover="hoverKey = 35" @mouseleave="hoverKey = -1">
                            <!-- <img :src="hoverKey == 35 ? '/images/category-active.svg' : '/images/category.svg'"
                                class="pointer" /> -->
                                <svg width="20" height="20" class="pointer svg-icon">
      <use :xlink:href="hoverKey == 35 ? '/images/svg/sprite.svg#category-active-icon':'/images/svg/sprite.svg#category-icon'"></use>
    </svg>
                        </div>
                    </a-popover>
                </a-col>
                <a-col :xs="4" :sm="4" :md="4" :lg="12" :xl="13" :xxl="16" class="header-menu pl-3">
                        ...
                        <a-menu-item key="buyCrypto">
                            ...
                            <!-- <a-popover :title="false" trigger="hover" placement="bottomLeft"
                                ...
                                <div class="icon-img" @mouseover="hoverKey = 23" @mouseleave="hoverKey = -1"
                                    ...
                                    {{ $t('public.ph16') }}
                                    <img
                                        :src="hoverKey == 23 ? '/images/up-active-arrow.svg' : '/images/down-arrow.svg'" />
                                </div>
                            </a-popover> -->
                        </a-menu-item>
                        ...
                        <a-menu-item key="trade" @mouseover="hoverKey = 22" @mouseleave="hoverKey = -1">
                            <a-popover :title="false" trigger="hover" placement="bottomLeft"
                                ...
                                <div class="icon-img" @mouseover="hoverKey = 22" @mouseleave="hoverKey = -1"
                                    ...
                                    {{ $t('public.ph24') }}
                                    <!-- <img :src="hoverKey == 22 ? '/images/up-active-arrow.svg' : '/images/down-arrow.svg'" /> -->
                                    <svg width="12" height="6" class="svg-icon">
      <use :xlink:href="hoverKey == 22 ?  '/images/svg/sprite.svg#up-active-arrow-icon':'/images/svg/sprite.svg#down-arrow-icon'"></use>
    </svg>
                                </div>
                            </a-popover>
                        </a-menu-item>
                ...
                <a-col :xs="8" :sm="8" :md="9" :lg="8" :xl="8" :xxl="6" align="end" class="right-side-icons">
                    <div style="display:flex; justify-content:flex-end; align-items:center;">
                        <div v-if="!$store.state.hex_uid.value" class="mr-1">
                            <a-button type="default" class="login-btn fw-5 mr-1 header-menu">
                                <nuxt-link to="/login">{{ $t('public.ph27') }}</nuxt-link>
                            </a-button>

                            <a-button type="primary" class="register fw-5 header-menu"><nuxt-link to="/register">{{
                                $t('public.ph28')
                            }}</nuxt-link></a-button>
                        </div>
                        <div v-else>
                                                    ...
                                                    <a-row :gutter="16" class="user-sec1">
                                                        ...
                                                        <a-col :lg="20" class="pr-0">
                                                            ...
                                                            <span class="menu-sub-txt fw-5"
                                                                ...
                                                                {{
                                                                    $store.getters.get_client_exchange_rate_name.mark
                                                                }} {{$store.getters.get_client_exchange_rate('USDT', $userassets.totalgame) }}
                                                            </span>
                                                            <span class="menu-sub-txt fw-5" v-else>{{
                                                                $store.getters.get_client_exchange_rate_name.mark
                                                            }}
                                            ...
                                            <div class="px-4 header-list">
                                                <nuxt-link to="/rewards-hub">
                                                    <a-row :gutter="16" class="user-sec1">
                                                        ...
                                                        <a-col :lg="20" class="pr-0">
                                                            <p class="menu-list-text fw-5 pt-1">{{ $t('tableskeys.bh5') }}</p>
                                                            <span class="menu-sub-txt fw-5"
                                                                v-if="$usersettings.moreconfig?.fundsvisible">{{
                                                                    $store.getters.get_client_exchange_rate_name.mark
                                                                }} {{
    $store.getters.get_client_exchange_rate('USDT',
        $userassets.totalgift)
                                    ...
                                    <div class="icon-img orderimg-icon" @mouseover="hoverKey = 20"
                                        ...
                                        {{ $t('public.ph35') }}
                                        <!-- <img
                                            :src="hoverKey == 20 ? '/images/up-active-arrow.svg' : '/images/down-arrow.svg'" /> -->
                                            <svg width="12" height="6" class="svg-icon">
      <use :xlink:href="hoverKey == 20 ?  '/images/svg/sprite.svg#up-active-arrow-icon':'/images/svg/sprite.svg#down-arrow-icon'"></use>
    </svg>
                                    </div>

                                </a-popover>
                            </span>
                            <span class="wallet fw-5 ml-3 header-menu " @mouseover="hoverKey = 21" @mouseleave="hoverKey = -1">
                                <a-popover :title="false" trigger="hover" placement="bottom"
                                    ...
                                    <div class="icon-img orderimg-icon" @mouseover="hoverKey = 21"
                                        ...
                                        {{ $t('public.ph47') }}
                                        <!-- <img
                                            :src="hoverKey == 21 ? '/images/up-active-arrow.svg' : '/images/down-arrow.svg'" /> -->
                                            <svg width="12" height="6" class="svg-icon">
                                            <use :xlink:href="hoverKey == 21 ?  '/images/svg/sprite.svg#up-active-arrow-icon':'/images/svg/sprite.svg#down-arrow-icon'"></use>
                                            </svg>
                                ...
                                <a-popover :title="false" trigger="hover" placement="bottomLeft"
                                    ...
                                    <template slot="content">
                                        <span @mouseover="hoverKey = 26" @mouseleave="hoverKey = -1">
                                                ...
                                                <nuxt-link to="/person/invitation">
                                                    <div class="header-list">
                                                        <a-row :gutter="16" class="user-sec col-alignment">
                                                            ...
                                                            <a-col :lg="20" class="pr-0">
                                                                <p class="menu-list-text fw-5 mb-0">{{ $t('public.ph51') }}</p>
                                                            </a-col>
                                                        </a-row>
                                                    </div>
                                                </nuxt-link>
                                            ...
                                            <div class="px-4 header-list pointer" @click="quitAccount">
                                    ...
                                    <span @mouseover="hoverKey = 26" @mouseleave="hoverKey = -1">
                                        <!-- <img :src="hoverKey == 26 ? '/images/user-active.svg' : '/images/user.svg'"
                                            class="pointer header-icon-img" /> -->
                                            <svg width="24" height="24" class="svg-icon pointer header-icon-img" >
                                                 <use :xlink:href="hoverKey ==  26  ? '/images/svg/sprite.svg#user-active-icon':'/images/svg/sprite.svg#user-icon'"></use>
                                           </svg>
                                    </span>
                                </a-popover>
                            </span>
                            <span @mouseover="getListNotifications" class="ml-3 header-menu ">
                                <span @mouseover="hoverKey = 30" @mouseleave="hoverKey = -1">
                                    ...
                                    <a-popover :title="false" trigger="hover" placement="bottomLeft"
                                                    ...
                                                    <a-row :gutter="16" class="user-sec col-alignment">
                                                        ...
                                                        <a-col :lg="19">
                                                            <p class="mb-0 num-color fw-6">{{ $t('public.ph48') }} <a-badge
                                                                    :count="notificationCount" class="ml-1"
                                                                    :overflow-count="9999"></a-badge>
                                                            </p>
                                                        </a-col>
                                                                ...
                                                                <a-row :gutter="16" class="user-sec1">
                                                                    ...
                                                                    <a-col :lg="20">
                                                                        <span class="pointer" @click="goTo(list.typeid)">
                                                                            <p class="mb-1 view-txt fw-5">{{ list.title }}</p>
                                                                            <p class="view-task fw-5 mb-0 truncateLongTexts">{{
                                                                                list.content
                                                                            }}</p>
                                                                            <p class="view-task fw-5 mb-0 truncateLongTexts">{{
                                        ...
                                        <span @mouseover="hoverKey = 30" @mouseleave="hoverKey = -1">
                                            <!-- <img :src="hoverKey == 30 ? '/images/notification-active.svg' : '/images/notification.svg'"
                                                class="pointer header-icon-img" /> -->
                                                <svg width="24" height="24" class="svg-icon pointer header-icon-img" >
      <use :xlink:href="hoverKey == 30 ? '/images/svg/sprite.svg#notification-active-icon':'/images/svg/sprite.svg#notification-icon'"></use>
    </svg>
                                        </span>
                                    </a-popover>
                                </span>
                        ...
                        <div class="list-sub-menu">
                            <span @mouseover="hoverKey = 27" @mouseleave="hoverKey = -1" class="ml-3 header-menu">
                                <a-popover :title="false" trigger="hover" placement="bottom"
                                    ...
                                    <template slot="content">
                                        <span @mouseover="hoverKey = 27" @mouseleave="hoverKey = -1">
                                            <div class="text-center">
                                                ...
                                                <nuxt-link to="/services/downloads"> <a-button
                                                        class="cancel-outline-btn fw-5 download-app-btn mt-2 mb-3">
                                                        {{ $t('depositModal.dm12') }}
                                                    </a-button></nuxt-link>
                                            </div>
                                        </span>
                                    ...
                                    <span @mouseover="hoverKey = 27" @mouseleave="hoverKey = -1">
                                            ...
                                            <svg  class="pointer header-icon-img svg-icon" width="24" height="24">
      <use :xlink:href="hoverKey == 27 ?  '/images/svg/sprite.svg#download-active-icon':'/images/svg/sprite.svg#download-icon'"></use>
    </svg>
                                    </span>
                                </a-popover>
                            </span>
                            <span @mouseover="hoverKey = 24" @mouseleave="hoverKey = -1" class="ml-3">
                                    <svg  class="pointer header-icon-img svg-icon" width="24" height="24" @click="handleLanguageModal()">
      <use :xlink:href="hoverKey == 24 ?  '/images/svg/sprite.svg#global-active-icon':'/images/svg/sprite.svg#global-icon'"></use>
    </svg>
                            </span>
                            <span @mouseover="hoverKey = 25" @mouseleave="hoverKey = -1" class="ml-3">
                                <!-- <span class="mb-0 usd-txt fw-5 pt-1" @click="handleExchangeModal()">USD</span> -->
                                    <svg  class="pointer header-icon-img svg-icon" width="24" height="24" @click="handleExchangeModal()">
      <use :xlink:href="hoverKey == 25 ?  '/images/svg/sprite.svg#exchange-active-icon':'/images/svg/sprite.svg#exchange-icon'"></use>
    </svg>
                            </span>
                        </div>
                    </div>
                ...
                <div class="main-content">
                    <a-row :gutter="24">
                        <a-col :lg="12" class="pt-2">
                            <p class="p2p-account-heading fw-5 mb-1">{{ $t('public.ph59') }}</p>
                            <span class="p2p-account-desc fw-5 mr-5">{{ $t('public.ph60') }} <br>{{ $t('public.ph61') }}</span>
                        </a-col>
                    </a-row>
                </div>
            </div>
                ...
                <div class="main-content">
                    <a-row :gutter="24">
                        <a-col :lg="24">
                            ...
                            <span class="p2p-myads-desc fw-5 mr-5">{{ $t('public.ph63') }}<br /> {{ $t('public.ph64') }}</span>
                        </a-col>
                    </a-row>
                </div>
            </div>
