<template>
    <div class="invite-friend-modal">
        <a-modal id="invite-user-modal" v-model="inviteUserModel" :footer="false" :title="false" @cancel="close"
            width="678px">
                        ...
                        <a-col :lg="24">
                            <a-row type="flex" justify="space-between" align="middle" class="link-card fw-5">
                                ...
                                <a-col> <span id='keycopy' class="deposit-address-link"
                                        :title="`https://bitnasdaq.com/invite?ref=${$userinfo.invitationcode}`">https://bitnasdaq....</span>
                        ...
                        <a-col :lg="24">
                            <div class="social-icon mb-2 pt-3">
                                ...
                                <span @click="openTwitter" @mouseover="hoverKey = 5" @mouseleave="hoverKey = -1"
                                    class="pointer pr-2 mr-2">
                                    <img :src="hoverKey == 5 ? '/images/tw-icon-active.svg' : '/images/tw-icon.svg'"
                                        height="58px" />
                        ...
                        <a-col :lg="24">
                            <div class="social-icon">
                                ...
                                <span @click="openEmail" @mouseover="hoverKey = 10" @mouseleave="hoverKey = -1"
                                    class="pointer pr-2 mr-2">
                                    <img :src="hoverKey == 10 ? '/images/email-icon-home.svg' : '/images/email5.svg'"
                                        height="58px" />
...
export default {
    ...
    methods: {
        ...
        getSharedValues() {
            const _self = this;
            const refer = `${_self.$store.state.hex_config.DomanUrl}/invite?ref=${_self.$userinfo.invitationcode}`;
        ...
        openFacebookLogin() {
                ...
                const hostedPageURL = "https://bitnasdaq.com/invite?ref=1274DA";
