        ...
        <a-modal id="add-payment" v-model="verificationModel" width="400px" :footer="false" @cancel="close()"
            ...
            <a-row class="px-4 pt-4">
                ...
                <a-col :lg="8" align="end" class="pointer">
                    <img src="/images/ud-cross.svg" @click="close()" class="pointer p-2" />
                </a-col>
            </a-row>
            ...
            <a-row class="px-4">
                <a-col :lg="24">
                    <a-form-model ref="verification" :hide-required-mark="true" label-align="left" :model="verify"
                        ...
                        <a-row :gutter="16">
                            <a-col :lg="24">
                                <p class="verification-paypass fw-5"><img src="/images/fund-pass1.svg" class="mr-2" />
                                    <span>
                                        {{ $t('person.pd22') }}
                                    </span>
                                </p>
                                <a-form-model-item has-feedback prop="paypassword" :colon="false" :wrapper-col="{
                                    ...
                                    <a-input-password v-model="verify.paypassword" :placeholder="$t('person.pd22')" />
                                </a-form-model-item>
                            </a-col>
                            ...
                            <a-col :lg="24">
                                ...
                                <a-form-model-item has-feedback prop="googleVerifyCode" :colon="false" :wrapper-col="{
                                    ...
                                    <a-input v-model="verify.googleVerifyCode" :max-length="6" type="number"
                                        :placeholder="$t('placeholders.google_authenticater_code')" />
                                </a-form-model-item>
                            </a-col>
                            <a-col :lg="24" align="end">
                                <nuxt-link to="/person/security/password-capital" class="forgot-pass fw-5">{{
                                    $t('last.la18')
                                }}</nuxt-link></a-col>
                        ...
                        <a-row :gutter="16" class="pb-4 pt-3">
                            <a-col :lg="24" align="end">
                                <a-button class="cancel-outline-btn fw-5 mr-2 px-4" @click="close">{{ $t('person.pd18')
                                }}</a-button>
                                <a-button class="primary-btn fw-5 px-4" @click="Confirm" :loading="loading"
                                    :disabled="loading">{{ $t('person.pd19') }}</a-button>
                            </a-col>
                        </a-row>
                    </a-form-model>
                </a-col>
...
export default {
    ...
    emits: ['onClose'],
    watch: {
        verificationModel: function (val) {
            this.verify = {
                googleVerifyCode: "",
                paypassword: ""
            }
